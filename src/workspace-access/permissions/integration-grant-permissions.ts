...
export const INTEGRATION_GRANT_PERMISSION_CATALOG = [
  ...
  },
  {
    key: "write",
    type: "option" as const,
    description: "Написання в розмові",
    options: [
      { value: "all", label: "Усі" },
      { value: "mine", label: "Мої" },
    ],
  ...
  },
  {
    ...
    description: "Призначення відповідального",
    default: false,
  },
  {
    key: "canTakeChat",
    type: "boolean" as const,
    description: "Брати непризначені чати",
    default: false,
  },
  {
    key: "instagramCommentsView",
    type: "boolean" as const,
    description: "Перегляд коментарів [Instagram]",
    default: false,
  ...
  },
  {
    ...
    type: "boolean" as const,
    description: "Написання коментарів [Instagram]",
    default: false,
    integrationTypes: ["instagram"] as const,
  },
] as const;
