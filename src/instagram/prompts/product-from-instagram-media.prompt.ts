...
export function buildProductFromInstagramUserText(params: {
  ...
  return [
    ...
    catalogBlock,
    "",
    "Workspace custom fields: використовуй тільки ті поля, що вже існують у робочому просторі; не створюй нові поля.",
    "Для option-полів можеш запропонувати нові варіанти значень, якщо це доцільно.",
    "",
    ...
    "Нагадування: не вигадуй нових полів характеристик. Якщо характеристика не відповідає жодному існуючому полю — не включай її до matchedCustomFields.",
  ].join("\n");
}
